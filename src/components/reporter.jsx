...
export default function Reporter() {
  ...
  const options = ["Alice Harmon", "Peter Kim", "Kuang Li"];
          ...
          <div className="absolute mt-1 w-full bg-white border rounded-md shadow-md z-10">
            {options.map((item) => (
              <div
                ...
                className={`w-full px-3 py-2 flex items-center justify-start text-primary text-sm cursor-pointer hover:bg-gray-100 ${
