...
export default function Leftticket({value,functionn,hide,sethide}){
    ...
    return(
        <>{hide?<div className="min-w-[57px] h-screen flex flex-col items-center justify-start py-4">
            <ChevronsRight size={31} color="black" onClick={(e)=>{e.stopPropagation();handlehide()}}/>
            </div>:<div className={`relative z-20 min-w-[22.3%] flex flex-col items-center h-screen rounded-l-[23px] shadow-md 2xl:min-w-[21.3%] bg-white`}>
